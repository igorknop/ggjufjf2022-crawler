...
export const CARDS_GIANT_RATS = [
  ...
  { text: "GiantRat06", enemy: {name: 'GiantRat', damage:0, hitPoints: 1, effects:[{type:EFFECT_ATTACK, value: 1}]}, player: {name: 'Waist Cloth', effects:[{type:EFFECT_DEFENSE, value:1}, {type:EFFECT_ATTACK, value:3, req:['A']},], set:['A','B']}},
];
