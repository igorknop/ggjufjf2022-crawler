...
export const CARDS_GIANT_RATS = [
  ...
  { text: "GiantRat04", enemy: { name: 'Giant Rat', damage: 0, hitPoints: 1, effects: [{ type: EFFECT_ATTACK, value: 1 }], hint: "A bizarre, oversided pestilent animal" }, player: { name: 'Ragged thong', effects: [{ type: EFFECT_ATTACK, value: 1 }, { type: EFFECT_DEFENSE, value: 1, req:['B'] },], set: ['A', 'D'], slot:SLOTS.LEGS, hint: "A few pieces of cloth can be used to keep your secrets" } },
